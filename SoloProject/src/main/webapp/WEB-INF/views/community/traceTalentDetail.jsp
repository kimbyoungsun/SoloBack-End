              ...
              <div class="card border mb-4 mt-3">
                ...
                <div class="card-body container">
                  <div class="d-flex align-items-center mb-2">
                    ...
                    <img src="${path}/resources/static/img/avatar/avatar-2.jpg" alt="유저 프로필 이미지" style="height: 40px; border-radius: 50%;" />
                    </div>
                  ...
                  <div class="d-flex align-items-center mb-2">
                    <div class="border-1 bg-light rounded-circle flex-shrink-0">
                      <img src="${path}/resources/static/img/avatar/avatar-3.jpg" alt="유저 프로필 이미지" style="height: 40px; border-radius: 50%;" />
                    </div>
                    <div class="row ms-2 container">
                      <div class="col-10">
